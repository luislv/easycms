...
<td width="1%">&nbsp;</td>
<td align="left"><?php echo form::getform('parentid',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('如果为一级栏目，不需选择！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span
></td>
</tr>
</td>
    </tr>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" id="table2">
  <tbody id="single" style="display:block;">
    <tr>
      ...
      <td width="1%">&nbsp;</td>
      <td align="left"><input type="text" class="input" name="catname" id="catname" /><span class="hotspot" onmouseover="tooltip.show('请填写栏目名称！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span></td>
    </tr>
 <tr>
      <td width="149" height="25" align="right">栏目副标题</th>
      <td width="1%">&nbsp;</td>
      <td align="left"><input type="text" class="input" name="subtitle" id="subtitle" /><span class="hotspot" onmouseover="tooltip.show('栏目自定义副标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span></td>
    </tr>
    <tr>
      <td width="149" height="25" align="right">目录名称</th>
      <td width="1%">&nbsp;</td>
      <td align="left"><input type="text" class="input" name="htmldir" id="htmldir" /><span class="hotspot" onmouseover="tooltip.show('目录必须是英文名，留空则自动使用拼音名，请勿夹杂符号！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span></td>
    </tr>
  </tbody>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('isnav',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('如果是一级目录，可选择是否在导航中显示栏目名称和链接！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
</tr>
...
<input name="showhtmlrule1" type="text" class="input" value="<?php echo $data['showhtmlrule'];?>" />
